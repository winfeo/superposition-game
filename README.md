...
<div align="center">
  ...
  <p>
    Многопользовательская интерактивная игра по тематике квантовых вычислений
  </p>
...
> [!NOTE]
> Backend уже развёрнут, приложение подключается к нему автоматически. Пользователю достаточно
